...
const ServiceDetail: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 relative" ref={containerRef}>
      ...
      <div className="max-w-4xl mx-auto py-12 pt-24 sm:pt-28">
        <div className="mb-6">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">What I Offer</h2>
          <p>My {service.title.toLowerCase()} services include comprehensive solutions tailored to your specific needs:</p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">My Process</h2>
          <p>I follow a structured approach to ensure high-quality results:</p>
